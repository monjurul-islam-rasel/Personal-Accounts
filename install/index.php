...
<html>
    <head>
        <title>Personal Accounts Installation Wizard</title>
        ...
        <div class="main">
            ...
            <div class="main-agilerow"> 
                <div class="ci-install-wrap">
                    ...
                    <span class="ci-subt">Income Expense Management</span>
                    <hr />
                    <h2>Install Now</h2>
                    <p>Ajax Based CI Installer
                        
                    </p>
                    <span style="float:right; color:white;"> 
                            by - <a target="_blank" class="btn btn-link" href="https://www.sbtechvalley.com/">SB TechValley</a>
                        </span>
                    <br />
                </div>	
