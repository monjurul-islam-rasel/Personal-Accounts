...
if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST) {
	...
	if($core->checkEmpty($_POST) == true)
	{
            ...
            {
                    $message = $core->show_message('error',"The database could not be created.<br /> Make sure database - <strong>host, user, password, database name is correct</strong>.");
            } 
