...
<div class="x_panel">
	...
	<div class="x_content">
		...
		<form id="demo-form" data-parsley-validate>
			...
			<button style="float: right;" type="button" class="btn btn-primary" onclick="create_category()">Create
				Category
			</button>
	...
	function create_category() {
		...
		if (name != "" && status != "") {
			$.ajax({
				...
				data: {parent_id: parent_id, name: name, details: details, status: status},
