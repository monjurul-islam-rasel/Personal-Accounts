<?php
   ...
   $qry_cat = $this->db->get_where('category', array('parent_id' => 0, 'cat_type'=>1 ));
...
<div class="x_panel">
   <div class="x_content">
      ...
      <form id="demo-form" data-parsley-validate>
         ...
         <button style="float: right;" type="button" class="btn btn-primary" onclick="create_inc_category()">
   	...
   	if (name != "" && status != "") {
   		$.ajax({
   			...
   			success: function (html) {
   				if (html == 1) {
   					alert('New Income Category Created Successfully.');
   					location.reload();
   				}
   				else {
