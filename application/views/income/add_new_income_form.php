        ...
        <form id="demo-form" onchange="validate_form()" onkeyup="validate_form()">
            ...
            <p>
                <select id="payment_status" name="payment_status" class="form-control">
                    ...
                    <option value="1" title="Payment Processed for this Income">Payment Processed</option>
                    <option value="0" title="Payment Not Processed for this Income">Payment Not Processed</option>
                </select>
            ...
            <button disabled id="add_income_submit_btn" style="float: right" type="button" class="btn btn-success"
                    onclick="create_income()">Add Income
            </button>
...
<script>
    ...
    function create_income() {
        ...
        if (fv == 1) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo site_url("income/add_income")?>",
                data: {
                    category: category,
                    amount: amount,
                    purpose: purpose,
    ...
    function validate_form() {
        ...
        if (fv == 0) {
            $("#form-error").html('<span>Please Fill The Form Correctly.</span>');
            $("#add_income_submit_btn").prop("disabled", true);


        }
        else {
            $("#form-error").html('');
            $("#add_income_submit_btn").prop("disabled", false);
        }
    }
</script>
